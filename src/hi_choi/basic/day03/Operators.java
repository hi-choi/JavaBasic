...
public class Operators {
	...
	public static void main(String[] args) {
		...
		//피연산자의 어느쪽에 위치ㅏ는가에 따라 연산의 순서가 달라짐
		//i = 1 => i = i + 1 => i += 1 => ++i
		//		=> i = i + 3 => i += 3
		
		int a = 7, b = 7;
		int result3 = ++a + 10;	//a값 증가시킨 후 연산에 적용(전치)
		int result4 = b++ + 10;	//a를 연산해 사용한 후 값증가(후치)
