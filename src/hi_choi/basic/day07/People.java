...
public class People {
    public static void main(String[] args) {
        ...
        // 클래스에 정의된 필드와 기능이 실제 메모리에 핟당된 것임
        ...
        // 학생 클래스 사용하기
        Student S = new Student("201350050", "김태희","경기도 고양시","1985.3.22","컴퓨터","504");
        Student S1 = new Student("201250006", "송혜교","서울 영등포구","1988.9.17","컴퓨터","301");
        Student S2 = new Student("201252110", "전지현","경기도 의정부","1986.4.30","의상디자인","445");
        Student S3 = new Student("201351010", "수지","서울 성북구","1988.7.13","식품영양","556");
        Student S4 = new Student("201353011", "아이유","경기도 천안시","1987.2.25","철학","504");
    ...
    static class Student{
        ...
        // 매개변수를 포함한 생성자
        public Student(String hakbun, String name, String address, String birth, String dname, String prof) {
            this.hakbun = hakbun;
            this.name = name;
