...
public class MidSungJuk {
    ...
    public void computeSungJuk (int kor, int eng, int mat) {
        this.tot = kor + eng + mat;
        this.avg = (double) tot / 3;
        switch((int)avg/10){
            case 10 : case 9 : this.grd = '우'; break;
            case 8 : this.grd = '수' ; break;
