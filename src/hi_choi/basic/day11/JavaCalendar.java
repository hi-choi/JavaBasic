...
public class JavaCalendar {
    public static void main(String[] args) {
        ...
        //fmt = "%d년 %d월 %d일 %d시 %d분 %d초\n";
        Calendar c = Calendar.getInstance();
        System.out.println(c.getTime());
        System.out.printf(fmt, c.get(Calendar.YEAR), c.get(Calendar.MONTH)+1, c.get(Calendar.DAY_OF_MONTH), c.get(Calendar.HOUR),c.get(Calendar.MINUTE), c.get(Calendar.SECOND));
        ...
        // 시간을 표현할 때느 LocalTime
        // 둘다 표현할 때느 LocalDateTime
