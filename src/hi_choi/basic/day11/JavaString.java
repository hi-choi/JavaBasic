...
public class JavaString {
    public static void main(String[] args) {
        ...
        if(str1 == str2)
            System.out.println("str1과 str2가 저장 위치가 같음");   // str2는 str1이 저장된 곳이 아닌 새로운 메모리에 저장되므로 서로 다른 값을 참조하므로 다르다.
        ...
        // 대문자롤 만드는 코드를 작성해보세요. (capitalization)
        ...
        // 골라서 대문자롤 만드는 코드를 작성해보세요. (capitalization)
        ...
        // format : c언어의 printf처럼 서식문자열을 이요해서
