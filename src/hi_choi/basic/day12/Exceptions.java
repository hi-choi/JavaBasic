...
public class Exceptions {
    public static void main(String[] args) throws IOException {
        ...
        try {
            System.out.print("1~9사이 정수를 입력해주세요. ");
            int num = sc.nextInt();
        ...
        try {
            ...
            BufferedWriter bw = new BufferedWriter(fw); //행단위로 데이터 기록(속도 빠름)
            bw.write(sjdata);
            bw.close();
            fw.close();
