...
public class Generics {
    public static void main(String[] args) {
        ...
        // 컬렉션 클래스에 컴파일시 타입체크를 해주는 기능

        // 즉, 클래스에 사용할 타입의 정보를 동적으로 넘겨줄수 있고
        // 실행시간에 발생할 수 있는 타입간 오류를 컴파일시간에
        // 발견할 수 있도록 해주는 기능
        // JDK 1.5에서 부터 추가된 기능
        ...
        //System.out.println(Integer.paserInt(numbers2[0]) + Integer.paserInt(numbers2[1]) + Integer.paserInt(numbers2[2]));
        // 오류발생 -> 비정상 형변환이 원인
