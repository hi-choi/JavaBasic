...
public class SungJukServiceV3Impl implements SungJukServiceV3 {
    ...
    public void initSungJuk3() {
        ...
        try (
            ...
            // json파일의 모든내용을 한번에 읽어 한줄에 lines 변수에 저장
            String lines = br.lines().collect(Collectors.joining());
            // System.out.println(lines);


            // 텍스트파일에 저장된 반정형데이터를
            // JSON 분석기(paser)를 이용해서
            // 메모리에 객체형태로 저장함
            ...
            for(int i= 0; i<jsons.size(); ++i){
                ...
                SungJukVO sj = new SungJukVO((String)json.get("name"), ((Long)json.get("kor")).intValue(),
